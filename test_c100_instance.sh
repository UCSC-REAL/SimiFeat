...
do
	...
	do
		...
		do
			...
			CUDA_VISIBLE_DEVICES=0 python3  main_fast.py --dataset cifar100 --noise_type $NOISE --k 10 --pre_type $PRE --noise_rate 0.4 --num_epoch 21 --Tii_offset 1.0 --method $METHOD  > ./results/cifar100/c100_$METHOD\_$PRE\_$NOISE.log
		done
	done
done
